...
import { NavLink, LinkHtml, SubNavLinks } from "#shared/ui";
                ...
                <DesktopNavBarContainer authenticated={authenticated ? 1 : 0}>
                    ...
                    {!accountPage && (
                        <LinksRow authenticated={authenticated}>
                            {NAVIGATION_LINKS.map(({ label, withHref, ...props }, index : number) => (
                                <React.Fragment key={label}>
                                    {
                                        (label !== 'About' && label !== 'Blog' && label !== 'FAQ') && 
                                        (
                                            withHref ? (
                                                ...
                                                >
                                                    ...
                                                    <span className={label === 'HOW IT WORKS' ? '_xto_' : ''}
                                                        onMouseOver={() => {
